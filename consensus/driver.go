...
func (d *driver) messageProcessor(msg p2p.Message) (reply *p2p.Message) {
...
func (d *driver) consensusRegister(consensusService IConsensusService, networkService p2p.IService) {
