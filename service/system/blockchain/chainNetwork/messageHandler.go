...
type p2pMessageHandler func(msg p2p.Message) *p2p.Message

func (p *P2PService) handlePushRequest(msg p2p.Message) (_ *p2p.Message) {
...
func (p *P2PService) handleSyncBlock(msg p2p.Message) (reply *p2p.Message) {
...
func (p *P2PService) handleSyncBlockReply(msg p2p.Message) (_ *p2p.Message) {
	defer func() {
		if r := recover(); r != nil {
...
func (p *P2PService) handleP2PMessage(msg p2p.Message) (reply *p2p.Message) {
